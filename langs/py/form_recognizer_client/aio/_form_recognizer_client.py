...
class FormRecognizerClient:
    ...
    :vartype form_recognizer: form_recognizer_client.aio.operations.FormRecognizerOperations
    :ivar models: ModelsOperations operations
    :vartype models: form_recognizer_client.aio.operations.ModelsOperations
    :ivar model: ModelOperations operations
    :vartype model: form_recognizer_client.aio.operations.ModelOperations
    :ivar analyze_results: AnalyzeResultsOperations operations
    :vartype analyze_results: form_recognizer_client.aio.operations.AnalyzeResultsOperations
    :ivar operations: Operations operations
    :vartype operations: form_recognizer_client.aio.operations.Operations
