...
{
    /// <summary> The ModelsAnalyzeResultsDocumentElementsTimeField. </summary>
    internal partial class ModelsAnalyzeResultsDocumentElementsTimeField
    {
        /// <summary> Initializes a new instance of ModelsAnalyzeResultsDocumentElementsTimeField. </summary>
        /// <param name="type"></param>
        /// <param name="content"></param>
        /// <param name="spans"></param>
        /// <param name="confidence"></param>
        /// <exception cref="ArgumentNullException"> <paramref name="content"/> or <paramref name="spans"/> is null. </exception>
        internal ModelsAnalyzeResultsDocumentElementsTimeField(ModelsAnalyzeResultsDocumentElementsTimeFieldType type, string content, IEnumerable<ModelsAnalyzeResultsDocumentElementsSpan> spans, double confidence)
        {
            if (content == null)
            {
        ...
        public ModelsAnalyzeResultsDocumentElementsTimeFieldType Type { get; }
