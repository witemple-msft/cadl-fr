...
{
    /// <summary> The ModelsAnalyzeResultsDocumentElementsDateField. </summary>
    internal partial class ModelsAnalyzeResultsDocumentElementsDateField
    {
        /// <summary> Initializes a new instance of ModelsAnalyzeResultsDocumentElementsDateField. </summary>
        /// <param name="type"></param>
        /// <param name="content"></param>
        /// <param name="spans"></param>
        /// <param name="confidence"></param>
        /// <exception cref="ArgumentNullException"> <paramref name="content"/> or <paramref name="spans"/> is null. </exception>
        internal ModelsAnalyzeResultsDocumentElementsDateField(ModelsAnalyzeResultsDocumentElementsDateFieldType type, string content, IEnumerable<ModelsAnalyzeResultsDocumentElementsSpan> spans, double confidence)
        {
            if (content == null)
            {
        ...
        public ModelsAnalyzeResultsDocumentElementsDateFieldType Type { get; }
