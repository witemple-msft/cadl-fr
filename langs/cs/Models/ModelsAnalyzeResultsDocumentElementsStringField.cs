...
{
    /// <summary> The ModelsAnalyzeResultsDocumentElementsStringField. </summary>
    internal partial class ModelsAnalyzeResultsDocumentElementsStringField
    {
        /// <summary> Initializes a new instance of ModelsAnalyzeResultsDocumentElementsStringField. </summary>
        /// <param name="type"></param>
        /// <param name="content"></param>
        /// <param name="spans"></param>
        /// <param name="confidence"></param>
        /// <exception cref="ArgumentNullException"> <paramref name="content"/> or <paramref name="spans"/> is null. </exception>
        internal ModelsAnalyzeResultsDocumentElementsStringField(ModelsAnalyzeResultsDocumentElementsStringFieldType type, string content, IEnumerable<ModelsAnalyzeResultsDocumentElementsSpan> spans, double confidence)
        {
            if (content == null)
            {
        ...
        public ModelsAnalyzeResultsDocumentElementsStringFieldType Type { get; }
